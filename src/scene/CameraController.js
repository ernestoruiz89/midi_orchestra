...
export class CameraController {
  constructor(camera, domElement, scene) {
    ...
    this.presets = {
      ...
      trumpet: { pos: new THREE.Vector3(3.6, 1.8, 1.8), target: new THREE.Vector3(4.2, 1.5, 0.4) },
      sax: { pos: new THREE.Vector3(4.3, 1.50, 2.5), target: new THREE.Vector3(3.8, 1.25, 1.4) },
